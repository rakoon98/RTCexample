package com.example.webrtctest.testsampletry

import android.util.Log
import com.example.webrtctest.testsampletry.view.TryActivity
import com.example.webrtctest.utils.getTimeHour
import com.example.webrtctest.utils.setLogDebug
...
//    private val sendChannel = ConflatedBroadcastChannel<String>()
    ...
    val connectListener = Emitter.Listener { con ->
        con.forEach {
            Log.d("요호호,", "connectListener : $it")
            process("$it")
        }
    }
...
//                    activity.rtcClient.answer(sdpObserver = activity.sdpObserver)
    ...
    fun onDestroy() {
        socket?.run {
            ...
            off("receive locations", msgListener)
